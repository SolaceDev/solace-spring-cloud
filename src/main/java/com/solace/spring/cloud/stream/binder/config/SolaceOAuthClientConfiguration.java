...
import com.solace.spring.cloud.stream.binder.oauth.DefaultSolaceSessionOAuth2TokenProvider;
  ...
  static class SolaceOAuth2SchemeCondition implements Condition {
    ...
    public boolean matches(ConditionContext context, AnnotatedTypeMetadata metadata) {
      return Binder.get(context.getEnvironment())
          .bind("solace.java", com.solace.spring.cloud.stream.binder.config.SolaceJavaProperties.class)
          .map(com.solace.spring.cloud.stream.binder.config.SolaceJavaProperties::getApiProperties)
