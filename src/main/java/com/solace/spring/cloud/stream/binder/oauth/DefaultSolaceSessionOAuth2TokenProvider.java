package com.solace.spring.cloud.stream.binder.oauth;
  ...
  public String getAccessToken() {
    try {
      ...
      final String oauth2ClientRegistrationId = jcsmpProperties
          .getStringProperty(com.solace.spring.cloud.stream.binder.config.SolaceJavaProperties.SPRING_OAUTH2_CLIENT_REGISTRATION_ID);
