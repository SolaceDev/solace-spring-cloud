...
import com.solace.spring.cloud.stream.binder.config.SolaceJavaProperties;
import com.solace.spring.cloud.stream.binder.config.SolaceOAuthClientConfiguration;
...
public class SolaceJavaAutoConfiguration {
    ...
    /**
     * Returns a {@link JCSMPProperties} based on {@link com.solace.spring.cloud.stream.binder.config.SolaceJavaProperties}.
     *
     * @return {@link JCSMPProperties} based on {@link com.solace.spring.cloud.stream.binder.config.SolaceJavaProperties}.
     */
    @Bean
    public JCSMPProperties getJCSMPProperties() {
        ...
        if (properties.getOauth2ClientRegistrationId() != null) {
            jcsmpProps.setProperty(com.solace.spring.cloud.stream.binder.config.SolaceJavaProperties.SPRING_OAUTH2_CLIENT_REGISTRATION_ID,
